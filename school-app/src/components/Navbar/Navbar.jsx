    ...
    <>
      ...
      <style>{`
        ...
        @media (min-width: 992px) {
          ...
          .nav-link-custom:hover { color: #D4A24C; }
          .nav-link-custom::after {
            content: "";
            position: absolute;
            left: 0;
        ...
        .pdf-link { text-decoration: none !important; }
        .pdf-link::after { display: none !important; }
        ...
        @media (max-width: 991px) {
          ...
          .custom-collapse.open { transform: translateX(0); }
          .mobile-brand { font-weight: 700; font-size: 18px; color: #D4A24C; margin-bottom: 20px; }
          .nav-link-custom { width: 100%; text-align: left; color: white; padding: 4px 0; border: none; background: none; }
          .nav-login-btn, .nav-signup-btn { width: 100%; margin-top: 6px; }
        }
        ...
        @media(max-width: 576px) {
          ...
          .brand-mobile { display: inline; font-size: 16px; font-weight: 800; }
        }
      `}</style>
    </>
  );
