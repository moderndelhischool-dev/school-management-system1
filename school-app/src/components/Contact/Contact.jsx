          ...
          <div className="col-lg-5">
            ...
            >
              <div className="map-container mb-4">
                <iframe
                  title="School Location"
                  src="https://www.google.com/maps?q=Modern%20New%20Delhi%20Public%20High%20School%20Ajjowal%20Hoshiarpur&output=embed"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen=""
              ...
              <div className="contact-details">
                <p>
                  <strong>Location:</strong> Vill. Ajjowal, Hoshiarpur, Punjab
                </p>
                ...
                <p>
                  <strong>Principal:</strong> 98551-06665
                </p>

                <p>
                  <strong>President:</strong> 98554-40343
                </p>
